        ...
        <div class="card-body">
            <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <input type="text" name="short_code" value="{{ $language->short_code }}" required class="form-control" placeholder="Enter Short Code"/>
                ...
                <div class="col-lg-4">
                    ...
                    <input type="text" name="name" value="{{ $language->name }}" required class="form-control" placeholder="Enter Name"/>
                ...
                <!-- <div class="col-lg-4">
                    ...
                    <input type="text" name="name_local" value="{{ $language->name_local }}" class="form-control" placeholder="Enter Local Name"/>
