...
class Helper
{
    ...
    {
        // $form_url = "{{ route('$controller.destroy',$id) }}";
        // $show_url = "{{ route('$controller.show',$id) }}";
        // $edit_url = "{{ route('$controller.edit',$id) }}";
        $btn = "
